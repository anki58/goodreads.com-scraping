...
2) The get_features.py uses webdriver and for fetching the reviews of all the reviewers it takes about a day.

3) Since we have used bucketization and have 3 outcomes possible for our prediction label, we were unable to calucate the R squared and area under the curve which work only for binary outcomes. We had even dropped you a mail regarding the same.
